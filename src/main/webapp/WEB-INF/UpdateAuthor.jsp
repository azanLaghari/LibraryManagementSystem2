...
<title>Update Author Form</title>
<style>
#authorReview {
...
<body>
 <div class="container">
        ...
        <form action="editAuthorServlet" method="post">
            ...
            <input type="text" authorId="authorId" name="authorId"value= "${author.authorId}" class="form-input"hidden><br><br>
           <label for="authorName" class="form-label">AuthorName:</label>
            <input type="text" authorId="authorName" name="authorName"value= "${author.authorName}" class="form-input"required><br><br>
            
            <label for="authorDateofBirth" class="form-label">AuthorDateofBirth:</label>
            <input type="authorDateofBirth" authorId="authorDateofBirth" name="authorDateofBirth"value= "${author.authorDateofBirth}"class="form-input" required><br><br>
