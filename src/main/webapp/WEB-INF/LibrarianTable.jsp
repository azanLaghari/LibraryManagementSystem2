...
<body>
   <form action="#" method="get">
    ...
    <form action="registerLibrarian" method="get">
			<input type="hidden" name="AddNewLibrarian">
				<input type="submit" value="Add New Librarian">
		</form>
		<br />
   <table border="1">
        <thead>
        ...
        <tbody>
            <!-- Iterate over the authorList attribute using JSTL forEach -->
            <c:forEach var="librarian" items="${librarianList}">
                <tr>
                    ...
                    <td>${librarian.dateOfBirth}</td>
                     <td><a href="editLibrarianServlet?librarianId=${librarian.librarianId}">Edit</a></td>
                    <td>
