...
<body>
<div class="container">
        <h2 style="text-align: center;">Update BooksOut</h2>
        <form action="editBooksOutServlet" method="post">
        
            <input type="text" id="id" name="id" value= "${booksOut.id}" class="form-input" hidden><br><br>
           ...
           <label for="authorId" class="form-label">Author:</label>				
            ...
            <label for="dateOfOut" class="form-label">DateOfOut:</label>
            <input type="dateOfOut" id="dateOfOut" name="dateOfOut" value= "${booksOut.dateOfOut}" class="form-input" required><br><br>
            
            <label for="dateOfReturn" class="form-label">DateOfReturn:</label>
            <input type="dateOfReturn" id="dateOfReturn" name="dateOfReturn" value= "${booksOut.dateOfReturn}" class="form-input" required><br><br>
