...
<body>
   <form action="#" method="get">
    ...
    <form action="registerMembers" method="get">
			<input type="hidden" name="AddNewMembers">
				<input type="submit" value="Add New Members">
		</form>
		<br />
    <table border="1">
        <thead>
        ...
        <tbody>
            <!-- Iterate over the membersList attribute using JSTL forEach -->
            <c:forEach var="members" items="${membersList}">       
                    ...
                    <td>${members.dateOfBirth}</td>
                     <td><a href="editMembersServlet?memberId=${members.memberId}">Edit</a></td>
                    <td>
                    <form action="deleteMembersServlet" method="post">
